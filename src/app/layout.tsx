...
export const metadata: Metadata = {
  ...
  description: 'Developed by Netanel Bezalel, AI Builder & Speaker',
}
  ...
  return (
    <ClerkProvider>
      <html lang="en" suppressHydrationWarning className={outfit.variable}>
        <body 
          className="font-outfit antialiased min-h-screen bg-gradient-to-br from-background to-background"
